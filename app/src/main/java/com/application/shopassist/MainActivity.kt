...
//            var shopList=db.shoppingListDao
            val scope = CoroutineScope(job + Dispatchers.Main)
            scope.launch {
                if(favDao.getAll().isEmpty()){
                    favDao.insert(Favourites("Vegetable oil","Cooking oil"))
                    favDao.insert(Favourites("Apple Juice","Beverage"))
                    favDao.insert(Favourites("Basmati Rice","Grains"))
                    favDao.insert(Favourites("Black pepper","Spices"))
                }
            }
...
//                    Toast.makeText(
//                        applicationContext,
//                        "Service is only available in Canada, changing location to Canada",
//                        Toast.LENGTH_SHORT
//                    ).show()
...
//                                Log.i("coun",sharedPreferences.getString("Country", default))
            }
        }
