...
//        fun compareSingleProduct(prodName: String) {
            // Fetch product data from the database
//            ProductDataManager.getIndividualProduct(prodName, object:
//                FirebaseCallback {
//                override fun onAsyncDataRetrieval(list: MutableList<Product>) {
//                    GlobalProducts.comparisonProductList = list
//                    println(GlobalProducts.comparisonProductList)
//                }
//            })
